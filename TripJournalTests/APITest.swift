...
final class APITest: XCTestCase {
    ...
    func testTripWithoutIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .trips(.GET, nil , nil, nil, nil)
        let urlString = value.urlString
        XCTAssertEqual("http://localhost:8000/trips", urlString)
    }
    
    func testTripWithIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .trips(.GET, 323, nil, nil, nil)
        let urlString = value.urlString
        XCTAssertEqual("http://localhost:8000/trips/323", urlString)
    }
    
    func testEventsWithoutIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .events(.GET, nil, nil, nil, nil)
        let urlString = value.urlString
        XCTAssertEqual("http://localhost:8000/events", urlString)
    }
    
    func testEventsWithIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .events(.GET, 333, nil, nil, nil)
        let urlString = value.urlString
        XCTAssertEqual("http://localhost:8000/events/333", urlString)
    }
    
    func testMediaWithoutIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .media(.POST, nil, nil, nil)
        let urlString = value.urlString
        XCTAssertEqual("http://localhost:8000/media", urlString)
    }
    
    func testMediaWithIDAPIURL() {
        let value: JournalServiceLive.APIEndPoints = .media(.POST, 123, nil, nil)
        let urlString = value.urlString
    ...
    func testTripRequestWithoutIDRequestURL() {
        let api = JournalServiceLive.APIEndPoints.trips(.GET, nil, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testTripRequestWithIDRequestURL() {
        let api = JournalServiceLive.APIEndPoints.trips(.GET, 1, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testCreateTripRequestMethod() {
        ...
        let api = JournalServiceLive.APIEndPoints.trips(.POST, nil, tripBody, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
        XCTAssertEqual("POST", request?.httpMethod)
    }
    ...
    func testDeleteTripRequestMethod() {
        let api = JournalServiceLive.APIEndPoints.trips(.DELETE, 1, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testUpdateTripRequestMethod() {
        ...
        let api = JournalServiceLive.APIEndPoints.trips(.PUT, 1, nil, tripBody, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testUpdateTripRequestBody() {
        ...
        let api = JournalServiceLive.APIEndPoints.trips(.PUT, 123, nil, tripBody, nil)
        let request = api.request
        XCTAssertNotNil(request)
        guard let request = request, let body = request.httpBody else {
            XCTFail("Error in handling the request")
    ...
    func testEventsRequestWithoutIDRequestURL() {
        let api = JournalServiceLive.APIEndPoints.events(.GET, nil, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testEventsRequestWithIDRequestURL() {
        let api = JournalServiceLive.APIEndPoints.events(.GET, 1, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testCreateEventsRequestMethod() {
        ...
        let api = JournalServiceLive.APIEndPoints.events(.POST, nil, eventBody, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
        XCTAssertEqual("POST", request?.httpMethod)
    }
    ...
    func testDeleteEventsRequestMethod() {
        let api = JournalServiceLive.APIEndPoints.events(.DELETE, 1, nil, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
        XCTAssertEqual("DELETE", request?.httpMethod)
    }
    ...
    func testUpdateEventsRequestMethod() {
        ...
        let api = JournalServiceLive.APIEndPoints.events(.PUT, 1, nil, eventBody, nil)
        let request = api.request
        XCTAssertNotNil(request)
        XCTAssertEqual("PUT", request?.httpMethod)
    }
    ...
    func testUpdateEventsRequestBody() {
        let currentDate = Date()
        let eventBody = EventUpdate(name: "Event 1",note: "Event Note 1" ,date: currentDate, location: Location(latitude: 1.0, longitude: 2.0), transitionFromPrevious: "No")
        let api = JournalServiceLive.APIEndPoints.events(.PUT, 123, nil, eventBody, nil)
        let request = api.request
        XCTAssertNotNil(request)
        guard let request = request, let body = request.httpBody else {
            XCTFail("Error in handling the request")
    ...
    func testMediaRequestWithoutIDRequestURL() {
        ...
        let api = JournalServiceLive.APIEndPoints.media(.POST, nil, mediaBody, nil)
        let request = api.request
        XCTAssertNotNil(request)
    ...
    func testMediaRequestWithIDRequestURL() {
        let api = JournalServiceLive.APIEndPoints.media(.DELETE, 1, nil, nil)
        let request = api.request
        XCTAssertNotNil(request)
